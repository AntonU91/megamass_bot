...
@Component
public class BackButtonHandler implements UserCallBackRequestHandler {
    TelegramService telegramService;
    UserSessionService userSessionService;
    KeyboardHelper keyboardHelper;

    @Autowired
    public BackButtonHandler(TelegramService telegramService, UserSessionService userSessionService, KeyboardHelper keyboardHelper) {
    ...
    public void handleCallBack(UserRequest userRequest) {
        ...
        telegramService.editMessage(userRequest.getUpdate(), "Moving on!", keyboardHelper.mainMenu());
    ...
    public boolean isCallbackApplicable(UserRequest userRequest) {
        return isValidCallBack(userRequest.getUpdate(), Constants.BACK);
    }
